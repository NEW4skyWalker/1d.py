...
trainDataset = DealDataset('E:/研究生/研究生课程资料/网络测量/tcp', "train-images-idx3-ubyte.gz","train-labels-idx1-ubyte.gz",transform=transforms.ToTensor())
testDataset = DealDataset('E:/研究生/研究生课程资料/网络测量/tcp', "t10k-images-idx3-ubyte.gz","t10k-labels-idx1-ubyte.gz",transform=transforms.ToTensor())
# 训练数据和测试数据的装载
